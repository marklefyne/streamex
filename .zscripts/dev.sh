...
# No cleanup trap — the dev server must survive after this script exits.
# The sandbox manages process lifecycle separately.
...
echo "Server started via nohup — will survive script exit."
